...
public class MovementController : MonoBehaviour
{
    ...
    private void HandleVoiceDetection()
    {
        ...
        //    {
        //        if (!isVoiceDetected) // Start the nodding process only if it hasn't been triggered yet
        //        {
        //            isVoiceDetected = true;

        //            // Start the coroutine to delay the head nodding
        //            noddingCoroutine = StartCoroutine(DelayedNod(1f)); // Delay of 1 second
        //        }
        //        return;
        //    }
        //    else
        //    {
        //        // Reset if no voice is detected
        //        isVoiceDetected = false;
        //        if (noddingCoroutine != null)
        //        {
        //            StopCoroutine(noddingCoroutine);
        //        }
        //    }
        //}
    }
